      ...
      <div class="row"> <!-- Membuat grid row Bootstrap -->
        ...
        <div class="col-sm-6"> <!-- Kolom setengah lebar -->
          <div class="mb-3"> <!-- Margin bawah -->
            ...
            <input type="text" name="nama_produk" class="form-control" value="{{ old('nama_produk') }}" > <!-- Input teks nama produk, value diisi ulang jika validasi gagal -->
        ...
        <div class="col-sm-6"> <!-- Kolom setengah lebar -->
          <div class="mb-3"> <!-- Margin bawah -->
            ...
            <input type="number" name="harga_produk" class="form-control" > <!-- Input angka harga produk -->
        ...
        <div class="col-12"> <!-- Kolom penuh -->
          <div class="form-floating"> <!-- Menggunakan form-floating Bootstrap -->
            <textarea class="form-control" name="deskripsi" placeholder="Leave a comment here" style="height: 100px"></textarea> <!-- Textarea untuk deskripsi produk -->
